 ...
 * @return {Function}
 */
export function dice (input: string): (random?: () => number) => number {
    let obj = parse(input)
 ...
 * @return {number}
 */
export function rollDice (times: number, face: number, modifier: number = 0, random = defaultRandom): number {
 ...
 * @return {Function}
 */
export function generateDice (times: number, face: number, modifier: number = 0): (random?: () => number) => number {
